...
public class ShowTaskOptionsAction extends AbstractTaskAction {
    ...
    public void execute(JComponent source, CComponent comp) {
        ...
        optionsPopup.handleEditProjectClick(e -> ActionManager.executeAction(Actions.SHOW_TASK_EDIT_FORM, (JComponent)e.getSource(), comp));
        optionsPopup.handleDeleteProjectClick(e -> ActionManager.executeAction(Actions.DELETE_TASK, (JComponent)e.getSource(), comp));
        optionsPopup.handleSetTaskStatusClick(e -> ActionManager.executeAction(Actions.SET_TASK_STATUS, (JComponent)e.getSource() , comp));
