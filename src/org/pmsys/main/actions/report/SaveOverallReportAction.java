...
public class SaveOverallReportAction implements SimpleAction {
    @Override
    public void execute(JComponent source, CComponent comp) {
        ...
        reportService.saveOverallReport(content);

        MessageUtils.SUCCESS("Overall report saved in /report/overall");
